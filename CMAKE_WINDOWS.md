...
The NSIS installer is generated by CPack from the `CPACK_NSIS_*` settings in [CMakeLists.txt](../CMakeLists.txt).

To customize the installer:
- Edit the `CPACK_NSIS_*` variables in `CMakeLists.txt`
